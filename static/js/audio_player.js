...
if (jsPlayer) {
	jsPlayer = {
		...
		// add a page tracker
		from_page: (document.getElementById('from_page') || {}),
		trackCount: 0,
    seeking: null,
		playing: false,
		tracks: [],
	...
	jsPlayer.preload = async function jsPlayerPreload(){
		console.log(jsPlayer.from_page.href)
		fetch(jsPlayer.from_page.href)
